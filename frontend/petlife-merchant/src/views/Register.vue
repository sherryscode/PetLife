    ...
    <div class="register-container">
      <div class="register-card">
        <div class="register-header">
          ...
          <p class="register-subtitle">创建您的商户账户，开启宠物服务之旅</p>
        </div>
        ...
        >
          <el-form-item prop="merchantName">
            <el-input 
              ...
              prefix-icon="Store"
              size="large"
              :class="{ 'input-focus': focusedField === 'merchantName' }"
              @focus="focusedField = 'merchantName'"
              @blur="focusedField = ''"
            />
          </el-form-item>
          ...
          <el-form-item prop="address">
            <el-input 
              ...
              size="large"
              :class="{ 'input-focus': focusedField === 'address' }"
          ...
          <el-form-item prop="contactName">
            <el-input 
              ...
              prefix-icon="User"
              size="large"
              :class="{ 'input-focus': focusedField === 'contactName' }"
              @focus="focusedField = 'contactName'"
              @blur="focusedField = ''"
            />
          </el-form-item>
...
async function handleRegister() {
  ...
  loading.value = true
  try {
    const response = await axios.post('/auth/merchant/register', {
